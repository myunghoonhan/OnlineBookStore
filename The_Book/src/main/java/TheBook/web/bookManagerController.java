...
public class bookManagerController {
	...
	public String bookManagerOrder(@ModelAttribute("orderVO") bookBuyVO vo, ModelMap model,
	...
	@ResponseBody public Map<String, Object> updateCondition (
																						HttpServletRequest request, 
																						HttpServletResponse response, bookBuyVO bvo,
																						bookBuyDetailVO vo) throws Exception {
		//session에 할당된 id 받아오기
		String memid = (String) request.getSession().getAttribute("session_memid");
	...
	public String bookManagerQnA(@ModelAttribute("qnaVO") bookQnaVO vo, ModelMap model,
																						HttpServletRequest request, 
																						HttpServletResponse response) throws Exception {
	...
	@ResponseBody public Map<String, Object> updateQnA (
																						HttpServletRequest request, 
	...
	public @ResponseBody Map<String, Object> deleteQnA(HttpServletRequest request, 
																										 HttpServletResponse response,
																										 bookQnaVO vo) throws Exception {
	...
	@ResponseBody public Map<String, Object> insertNotice(HttpServletRequest request, 
																												 HttpServletResponse response,
	...
	public String bookManagerNotice(@ModelAttribute("notiVO") bookNoticeVO vo,ModelMap model,
	...
	public String bookNoticesearch(@ModelAttribute("notiVO") bookNoticeVO vo, ModelMap model,
								HttpServletRequest request,  HttpServletResponse response) throws Exception {
	...
	public @ResponseBody Map<String, Object> modifynotice(HttpServletRequest request, 
																										 HttpServletResponse response,
																										 bookNoticeVO vo) throws Exception {
	...
	@ResponseBody public Map<String, Object> insertstNotice(HttpServletRequest request, 
																													 HttpServletResponse response,
	...
	public String bookMangerStore(@ModelAttribute("stnotiVO") bookStoreNoticeVO vo,
																									ModelMap model,
																									HttpServletRequest request, 
																									 HttpServletResponse response) throws Exception {
	...
	public String bookstModifyform(bookStoreNoticeVO vo, ModelMap model,HttpServletRequest request, 
																		HttpServletResponse response) throws Exception {
	...
	public @ResponseBody Map<String, Object> modifystnotice(HttpServletRequest request, 
																										 HttpServletResponse response,
																									 bookStoreNoticeVO vo) throws Exception {
	...
	public @ResponseBody Map<String, Object> deletestNotice(HttpServletRequest request, 
																							HttpServletResponse response,
																							bookStoreNoticeVO vo) throws Exception {
	...
	public String bookList(@ModelAttribute("bookVO") bookVO vo, 
	...
	@ResponseBody public Map<String, Object> nbookInsert(			final MultipartHttpServletRequest multiRequest,
																								HttpServletRequest request,
		...
		if(memid.equals("master") == false || memid == null){
			...
			while (itr.hasNext()) { // 다음 가져올 파일의 존재유무
				...
				if (!"".equals(file.getOriginalFilename())) {
					...
					System.out.println("name : " + file.getOriginalFilename() );
						//바깥에서 사용하려면 String을 선언 해준후 while문안에 넣어주고 그것을 밖에서 호출해서 db에 insert 해준다
			...
			String bounq = "c" + Integer.toString(bookUnqseq.getNextIntegerId()); // 분류번호 앞 c붙여줌
			vo.setBounq(bounq);
	...
	//책 수정페이지 
		...
		public String bookinfoform(bookVO vo, bookStockVO svo,  ModelMap model,HttpServletRequest request,
												HttpServletResponse response) throws Exception {
	...
	@ResponseBody public Map<String, Object> infoModify(			final MultipartHttpServletRequest multiRequest,
																										HttpServletRequest request,
																										HttpServletResponse response, bookVO vo)
																										throws Exception {
		//session에 할당된 id 받아오기
		...
		public String bookselectTest(bookLevelVO vo,  ModelMap model,HttpServletRequest request,
														HttpServletResponse response) throws Exception {
