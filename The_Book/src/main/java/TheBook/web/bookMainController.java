...
public class bookMainController {
	...
	@Resource(name = "bookMainService") //서비스
	...
	public @ResponseBody Map<String, Object> bookSearch (ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response,bookVO bookVO, bookLevelVO bookLevelVO) throws Exception {
		  ...
		  List<?> bookSeachBar = bookMainService.bookSeachBar(bookVO);
		  
	      
	      Map<String, Object> map = new HashMap<String, Object>();
	      
	      map.put("bookSeachBar", bookSeachBar);
	      return map;
	}*/
	
	//메인에서 검색시 
	@RequestMapping(value="/bookSearch.do")
	public String bookSearch(HttpServletResponse response, HttpServletRequest request,
			bookVO bookVO,bookMemberVO bookMemberVO, ModelMap model) throws Exception {
		 /*//라디오 버튼 리스트
		  String levelname = bookLevelVO.getLevelname();
		  */
	...
	public String clickJungoList(HttpServletResponse response, HttpServletRequest request,
			  bookRebookVO bookRebookVO ,ModelMap model) throws Exception {
	...
	public String searchgubun(HttpServletResponse response, HttpServletRequest request,
			 bookLevelVO bookLevelVO , ModelMap model) throws Exception {
	...
	public @ResponseBody Map<String, Object> jungInsert (ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response,bookLevelVO bookLevelVO) throws Exception {
	...
	public String searchbutton(HttpServletResponse response, HttpServletRequest request,
		 bookLevelVO bookLevelVO , bookMemberVO bookMemberVO, ModelMap model) throws Exception {
	...
	/*@RequestMapping(value = "/searchbutton.do", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> searchbutton (ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response,bookVO bookVO, bookLevelVO bookLevelVO) throws Exception {
	      ...
	      map.put("tagSearchList", tagSearchList);
	      return map;
	
	}*/
	
	@RequestMapping(value = "/baguniAdd.do", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> baguniAdd (ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response,bookVO bookVO, bookBaguniVO bookBaguniVO, bookLevelVO bookLevelVO) throws Exception {
		  int bagunitotal;
		  int baguniprice;
