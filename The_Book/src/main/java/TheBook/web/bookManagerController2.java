...
public class bookManagerController2 {
	...
	@ResponseBody public Map<String, Object> insertstNotice(HttpServletRequest request, HttpServletResponse response,
			 												bookStockVO stockVO, ModelMap model) throws Exception {
		
		if(stockVO.getStockstoreunq().equals("1") || stockVO.getStockstoreunq().equals("")){
			stockVO.setStockstoreunq("2 OR stockstoreunq = 3 OR stockstoreunq = 4");
		}
	...
	public String managerStockOrder(bookStoreOrderVO orderVO, ModelMap model,HttpServletRequest request, 
	...
	@ResponseBody public Map<String, Object> managerStockOrderInsert(HttpServletRequest request, HttpServletResponse response,
																bookStoreOrderVO orderVO) throws Exception {
	...
	@ResponseBody public Map<String, Object> managerStockOrderCheckSend(HttpServletRequest request, 
																											 HttpServletResponse response,
																		bookStoreOrderVO orderVO, bookBuyDetailVO detailVO) throws Exception {
