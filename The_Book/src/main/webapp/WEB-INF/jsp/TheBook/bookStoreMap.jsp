	...
	<main>
		<div class="container">
					  ...
					  <div class="container-fluid">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      <ul class="nav navbar-nav">
					        ...
					        <li class="active"><a href="/bookStoreMap.do?storeunq=${bookStoreVO.storeunq}">약도/주차</a></li>
					        <li class=""><a href="/bookStoreInfoMap.do?storeunq=${bookStoreVO.storeunq}">안내도</a></li>
					      </ul>
					    </div><!-- /.navbar-collapse -->
					  </div><!-- /.container-fluid -->
					</nav>
			...
			<div class="row" style="margin-bottom: 20px;">
			 	<div class="col-xs-12">
			 		<img src="/images/storeinfo/${selectVO.storeinfo1}" class="img-responsive" alt="Responsive image">
				</div>
		   </div>
		   </center>
