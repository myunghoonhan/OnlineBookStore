			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12" style="margin-top: 50px; text-align: center;">
						<img src="/images/eventlogo.png" class="img-responsive" alt="Responsive image" style="margin: 0 auto; width: 500px; height: auto;">
						...
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="background-color: #e5e5e5">
							...
							<div class="carousel-inner" role="listbox">
								...
								<div class="item active">
									<img src="/images/main4.jpg" class="carousel_img" alt="..." style="margin: 0 auto;">
									<div class="carousel-caption"></div>
								</div>
	
								<div class="item">
									<img src="/images/main5.jpg" class="carousel_img" alt="..." style="margin: 0 auto;">
									<div class="carousel-caption"></div>
								</div>
	
								<div class="item">
									<img src="/images/main6.jpg" class="carousel_img" alt="..." style="margin: 0 auto;">
									<div class="carousel-caption"></div>
								</div>
			...
			<div class="row">
				<div class="col-xs-12" style="margin-top: 10px; text-align: center;">
					<div class="embed-responsive embed-responsive-16by9">
					  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/3yRH9TgpLZU?amp;autoplay=1" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
